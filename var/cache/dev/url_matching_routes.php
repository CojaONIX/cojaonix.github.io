...
return [
    ...
    [ // $dynamicRoutes
        ...
        194 => [[['_route' => 'get_one_customer', '_controller' => 'App\\Controller\\CustomerController::getOneCustomer'], ['id'], ['GET' => 0], null, false, true, null]],
        217 => [[['_route' => 'update_customer', '_controller' => 'App\\Controller\\CustomerController::updateCustomer'], ['id'], ['PUT' => 0], null, false, true, null]],
        240 => [
